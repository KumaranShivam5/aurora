...
def make_plot(data_all):
    dates = [d[:12] for d in data_all['date']]
    plt.style.use('seaborn-dark-palette')
    
    f, ax = plt.subplots(3, 2, sharex=True , figsize=(16,8) ,constrained_layout=False)
    ...
    ax[1].errorbar(dates , data_all['flux_aper'] , uplims=data_all['flux_aper_hilim'],lolims=data_all['flux_aper_lolim'], fmt='.k' , capsize=2 , markersize=10 , label='flux')
    ...
    ax[5].plot(dates, data_all['flux_significance'] , label='Source Significance')
