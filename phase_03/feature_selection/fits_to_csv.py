...
def fits_to_csv(in_file , out_file , rows_file, class_int):
    ...
    #data['class'] = int(1)
print('CSV data')
fits_to_csv('../data/CVs/CV_heasarc_x_chandra.fits', 'cv_data.csv', 'rows_non_str.json', 0)
#print('LMXRB data')
fits_to_csv('../data/binaries/LMXB_all.fits', 'lmxrb_all_data.csv', 'rows_non_str.json', 1)